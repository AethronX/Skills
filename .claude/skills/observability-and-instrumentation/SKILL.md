...
**NOT for:**
- Diagnosing a failure happening right now — that's live debugging (this skill is what makes that fast next time)
...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see [OBSERVABILITY-CHECKLIST.md](OBSERVABILITY-CHECKLIST.md).
