...
- **Plan for deprecation at design time.** Announce, support the old and new shape in parallel for a stated window, then remove — on a timeline communicated to consumers up front, not decided after the fact.
