...
<!-- GOOD: Hero / LCP image — no lazy loading, high priority -->
<img
...
For the detailed checklist (images, fonts, network, database, measurement commands), see [PERFORMANCE-CHECKLIST.md](PERFORMANCE-CHECKLIST.md).
