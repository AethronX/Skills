...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in [SECURITY-CHECKLIST.md](SECURITY-CHECKLIST.md).
...
When data crosses a trust boundary, validate it as untrusted (see Input Validation above); when a privacy incident exposes personal data, the breach-notification clock is part of the postmortem.
...
For the full checklist and OWASP quick-reference tables, see [SECURITY-CHECKLIST.md](SECURITY-CHECKLIST.md).
