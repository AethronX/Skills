...
| Rounded everything (rounded-2xl) | Maximum rounding signals "friendly" but ignores real corner-radius hierarchy | Consistent border-radius from the design system |
| Generic hero sections | Template-driven layout with no connection to actual content or user need | Content-first layouts |
...
For detailed WCAG accessibility checks and testing tools, see [ACCESSIBILITY-CHECKLIST.md](ACCESSIBILITY-CHECKLIST.md).
